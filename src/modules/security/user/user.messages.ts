export const userMessages = {
  ...
  log: {
    ...
    recoveryVerifyPasswordSuccess: 'Verificación de recuperación de contraseña exitosa...',
  ...
  msg: {
    registerDefault: 'Usuario registrado exitosamente. Revise su correo para activar la cuenta.',
  ...
  validation: {
    disability: 'Este usuario ya está registrado, pero está deshabilitado. Por favor, póngase en contacto con los administradores.',
...
Ejemplo de un número válido: +582412345678 o 0412345678.`,
      password: 'La contraseña debe tener un mínimo de 8 caracteres y contener al menos 1 mayúscula, 1 minúscula, 1 número y un carácter especial.',
      code: {
        length: 'El campo code no puede tener más de 16 caracteres.',
        invalidCharacters: 'El campo code no puede tener caracteres no numéricos.',
      },
